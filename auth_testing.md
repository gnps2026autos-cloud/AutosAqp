...
```bash
# Test auth endpoint
curl -X GET "https://carsell-regional.preview.emergentagent.com/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://carsell-regional.preview.emergentagent.com/api/vehicles" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"
```
...
await page.context.add_cookies([{
    ...
    "domain": "carsell-regional.preview.emergentagent.com",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://carsell-regional.preview.emergentagent.com");
```
